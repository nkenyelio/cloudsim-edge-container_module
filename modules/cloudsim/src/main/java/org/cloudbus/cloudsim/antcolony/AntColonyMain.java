...
/**
 * A sample example showing how to create a data center with one host, one VM, one container and run one containercloudlet on it
 * @author ubuntu
 *
 */
...
*/
	public static void main(String[] args) {
		...
		try {
			...
			for (int k=1;k<=10;k++){
				...
				DatacenterbrokerAnt broker = createBroker();
	...
	//We strongly encourage users to develop their own broker policies, to submit vms and cloudlets according
		...
		private static DatacenterbrokerAnt createBroker(){

			DatacenterbrokerAnt broker = null;
			try {
				//int m, double Q, double alpha, double beta, double gamma, double rho
				broker = new DatacenterbrokerAnt("Broker",37,1,2,1,4,0.05);
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
