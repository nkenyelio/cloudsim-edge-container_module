...
public class DatacenterbrokerAnt extends SimEntity {
	 ...
	 * @post $none
	 */
	public DatacenterbrokerAnt(String name, int m, double Q, double alpha, double beta, double gamma, double rho) throws Exception {
		super(name);
	...
	protected void submitCloudlets() throws FileNotFoundException {
		...
		AntColonyOptDefault lbaco1 = new AntColonyOptDefault(m,Q,alpha,beta,gamma,rho);
