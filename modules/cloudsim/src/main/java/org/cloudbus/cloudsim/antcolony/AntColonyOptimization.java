...
public class AntColonyOptimization {protected double Q;
	...
	public Map<Integer,Integer> implement(List<ContainerCloudlet> clList,List<ContainerVm> vm_list,int tmax) throws FileNotFoundException{
	...
	protected double getExecutionTime(ContainerVm containerVm, ContainerCloudlet cloudlet){
